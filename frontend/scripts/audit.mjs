...
const ROUTES = [
  ...
  [process.env.SMOKE_DETAIL_PATH || '/collection/maratha-pattern-bronze-kavacha-vessel', 'artifact-detail'],
  ['/heritage', 'heritage'],
  ['/our-story', 'story'],
  ['/journal', 'journal'],
  [process.env.SMOKE_JOURNAL_DETAIL_PATH || '/journal/the-house-of-raajwarasa-an-introduction', 'journal-detail'],
  ['/enquire', 'enquire'],
  ['/contact', 'contact'],
  ['/terms', 'legal'],
  ['/does-not-exist', '404'],
